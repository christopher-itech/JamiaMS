        ...
        <Row>
          <Col md="12">
            <Card className="stacked-form">
              <Card.Header>
                <Card.Title as="h4">View exam result</Card.Title>
              </Card.Header>
              <Card.Body>
              {/* <Card.Body className="table-full-width"> */}
                    ...
                    <Table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="text-center">2135-563820</td>
                ...
                <Card className="stacked-form">
                  <Card.Header>
                    <Card.Title as="h5">Top positions</Card.Title>
                  </Card.Header>   
                  <Card.Body>      
                    <Table>
                      <thead>
                      ...
                      <tbody>
                        <tr>
                          <td className="text-center">1</td>
                          <td className="text-center">student name 1</td>
                          <td className="text-center">                          
                            91
                          </td>
                          <td className="text-center">                          
                        ...
                        <tr>
                          <td className="text-center">2</td>
                          <td className="text-center">student name 2</td>
                          <td className="text-center">                          
                            91
                          </td>
                          <td className="text-center">                          
                        ...
                        <tr>
                          <td className="text-center">3</td>
                          <td className="text-center">student name 3</td>
                          <td className="text-center">                          
                            91
                          </td>
                          <td className="text-center">                          
